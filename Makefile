...
up:
	...
	@echo ""
	@echo "  API Gateway (SDK):      http://localhost:8022"
	@echo "    - /router/*           Router Service"
	@echo "    - /memory/*           Hyphal Memory Service"
	@echo "    - /keys/*             Keys Service"
	@echo "    - /identity/*         Identity Service"
	@echo "    - /reinforcement/*    Reinforcement Service"
	@echo ""
	...
	@echo "  - Reinforcement:        http://localhost:8202"
	@echo ""
	@echo "  Observability:"
